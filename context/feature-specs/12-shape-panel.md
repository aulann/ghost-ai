...
3. When dragging a shape, include the shape name and default size in the frag payload.

   Use sensible default sizes:
   - rectangles should be wider then tall
...
- Shape drag payload includes correct shape and size data.
- Drop logic creates new canvas nodes with expected shape data.
